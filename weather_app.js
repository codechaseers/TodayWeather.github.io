...
const chose_city = document.querySelector(".chose_city")

let city = ["Bhadrack", "Cuttack", "Baripada", "Goa"]

search.addEventListener('input', (e) => {
  let city_array = []
  city_array = city.filter(find => find.toLowerCase().includes(e.target.value))
   
  
 for(i=0;i<=city_array.length ;i++)    {

  let item=`<li class="city_list"></li>`
   chose_city.innerHTML= item
   console.log("khjkjh"+city_array);
